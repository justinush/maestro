...
- Async callbacks / webhooks — [design](design/async-callbacks.md) (bridge validated)
- Custom action types — [design](design/custom-actions.md) (`validate.Options.AllowedActionTypes`)
